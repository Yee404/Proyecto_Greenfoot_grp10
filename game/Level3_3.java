...
/**
 * Write a description of class Level3_3 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Level3_3 extends World
{
    public static int score= 0;
    /**
     * Constructor for objects of class Level3_3.
     * 
     */
    public Level3_3()
    {    
    ...
    private void prepare()
    {
        ...
        Player2_3 player2 = new Player2_3();
        addObject(player2,1069,219);
        puntos5.setLocation(1004,39);
        puntos7.setLocation(891,49);
    }
}
